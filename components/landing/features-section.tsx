...
const features = [
  {
    ...
    description: "Bespoke applications built with the latest technologies. React, Node.js, Swift, Kotlin—we use the right tools for your vision.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Cloud-Native Solutions",
    description: "Scalable, secure applications on AWS, Azure, or GCP. DevOps best practices, containerization, and zero-downtime deployments.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Agile Partnerships",
    description: "Work with us as an extension of your team. Sprint planning, daily standups, and transparent communication throughout.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Production Excellence",
    description: "Robust testing, monitoring, and support. Security-first approach with OWASP standards and continuous compliance.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Our core services.
            <br />
            <span className="text-muted-foreground">Crafted for impact.</span>
          </h2>
        </div>
